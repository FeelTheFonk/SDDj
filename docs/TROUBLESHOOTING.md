...
| Quiet passages not still enough | Sub-floor blending automatically attenuates visual change during quiet passages. If still too dynamic, lower the max range in your modulation slot |
